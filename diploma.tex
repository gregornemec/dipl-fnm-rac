...
\documentclass[12pt, a4paper, onside, slovene]{article}
...
\input{izjava.tex}
\newpage
\input{program_dela.tex}
\newpage
\input{povzetek_si.tex}
\newpage
\input{povzetek_en.tex}
\newpage
...
\newpage
\input{./poglavja/02_uporaba_rac_izo.tex}
\newpage
\input{./poglavja/03_rac_znanost_prog.tex}
\newpage
\input{./poglavja/04_strategije_pouka.tex}
\newpage
\input{./poglavja/05_spup.tex}
\newpage
\input{./poglavja/06_kriteriji_za_klas.tex}
\newpage
\input{./poglavja/07_pregled_sp.tex}
\newpage
\input{./poglavja/08_nacini_uporabe.tex}
\newpage
\input{./poglavja/09_zakljucek.tex}
